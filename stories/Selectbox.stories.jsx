...
const SelectboxWrapper = () => {
  ...
  argTypes: {
    ...
    isDisabled: { description: 'Disables the selectbox', control: 'boolean' },
    placeholder: { description: 'Placeholder text shown when nothing is selected', control: 'text' },
    searchPh: { description: 'Placeholder text for the search input', control: 'text' },
    searchable: { description: 'Adds a search input inside the dropdown menu', control: 'boolean' },
    options: { description: "Array of option objects: `{ value, label, disabled? }`" },
    value: { description: 'Array of currently selected values (controlled multi-select)' },
    onChange: { description: 'Called with the updated array of selected values on each change' },
    width: { description: 'CSS width of the selectbox trigger' },
    menuHeight: { description: 'Maximum CSS height of the dropdown menu' },
    isLoading: { description: 'Shows a spinner inside the trigger and disables interaction' },
    loaderColor: { description: 'Color key for the loading spinner' },
    onLoadMore: { description: 'Called when the user scrolls to the bottom of the list (infinite scroll)' },
    hasMore: { description: 'Whether more options are available to load' },
    isLoadingMore: { description: 'Shows a spinner at the bottom while loading more options' },
  },
};
